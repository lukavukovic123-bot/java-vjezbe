...
► Konstruktor koji postavlja početne vrijednosti atributa. 
► Getere i setere za sve atribute (sa provjerama da broj kanala ≥ 1 i da je jačina tona u 
opsegu 0–10). 
► Metod pojacajTon() koji uvećava jačinu tona za 1, ali ne može preći 10. 
► Ako je x manji od 10 povećaj ga za jedan, a ako nije obavijesti da je već na max
 ► Metod ispisi() koji ispisuje broj kanala, naziv kanala i trenutnu jačinu tona
*/
