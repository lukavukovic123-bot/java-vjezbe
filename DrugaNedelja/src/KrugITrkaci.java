/*
U ovom zadatku staza je prsten između krugova sa centrom (cx, cy) i 
poluprečnicima R1<R2 . Unosi se N tačaka (xi,yi). 
Potrebno je prebrojati trkače koji su u prstenu uključujući granice i u 
gornjoj poluravni yi≥cy . 
Takođe je potrebno izračunati najudaljenijeg trkačima od centra, po 
euklidskom rastojanju
*/
